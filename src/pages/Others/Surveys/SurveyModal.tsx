...
const SurveyModal: React.FC<surverProps> = ({
  ...
  const handleSubmitCategory = (values: any, key: any) => {
        ...
        >
          ...
          >
            {showSurveyModal &&
              ...
              showSurveyModal.data.question_categories.map(
                (questionCategory: any, key: any) => {
                  return (
                    ...
                    >
                      <Form
                        onFinish={(values) =>
                          handleSubmitCategory(values, questionCategory.id)
                        }
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          >
                            {key !=
                            showSurveyModal.data.question_categories.length -
                              1 ? (
                              <>Valdate and Proceed</>
                            ) : (
                              <>Submit</>
