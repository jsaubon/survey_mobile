...
const SurveyModalPendingSumissions: React.FC<surveyPendingSubmissionsProps> = ({
	...
	return (
		<IonModal
			...
			onDidDismiss={(e) => setShowSurveySubmissions({ show: false, data: null })}
		>
			<div className="container" style={{ overflowY: "auto" }}>
				<Card
					title={showSurveySubmissions.data && showSurveySubmissions.data.form_type}
					extra={
						<Button
							onClick={(e) => setShowSurveySubmissions({ show: false, data: null })}
						>
							Close
						</Button>
					}
